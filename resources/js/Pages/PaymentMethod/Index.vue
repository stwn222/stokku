                ...
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 border">Nama Metode</th>
                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 border">Atas Nama</th>
                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 border">Nomor Rekening</th>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="px-4 py-3 text-sm text-gray-700 border">{{ paymentMethod.nama_metode }}</td>
                            <td class="px-4 py-3 text-sm text-gray-700 border">{{ paymentMethod.atas_nama || '-' }}</td>
                            <td class="px-4 py-3 text-sm text-gray-700 border">{{ paymentMethod.nomor_rekening || '-' }}</td>
                            <td class="px-4 py-3 text-sm text-gray-700 border">{{ paymentMethod.keterangan || '-' }}</td>

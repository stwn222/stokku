    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-2 text-white">
                ...
                <span>Barang</span>
                <ChevronRight :size="16" />
                <span class="font-semibold">Jenis Barang</span>
            </div>
        </template>
        ...
        <div class="bg-white rounded-lg shadow-md">
            ...
            <div class="border-b border-gray-200 p-6">
                <div class="flex items-center justify-between">
                    <h2 class="text-xl font-bold text-gray-800">Jenis Barang</h2>
                    <button 
                ...
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 border">Kode Jenis</th>
                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 border">Nama Jenis</th>
                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 border">Keterangan</th>
                            <th class="px-4 py-3 text-center text-xs font-semibold text-gray-700 border">Jumlah Barang</th>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="px-4 py-3 text-sm border">
                                <span class="inline-flex items-center px-2 py-1 bg-blue-100 text-blue-800 rounded font-mono font-semibold">
                                    {{ jenis.kode_jenis }}
                                </span>
                            </td>
                            <td class="px-4 py-3 text-sm text-gray-700 border">{{ jenis.nama_jenis }}</td>
                            <td class="px-4 py-3 text-sm text-gray-600 border">{{ jenis.keterangan || '-' }}</td>

    ...
    <AuthenticatedLayout>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 print:hidden">
                <h3 class="text-lg font-bold text-gray-800 mb-4">Filter Data Barang Masuk</h3>
            ...
            <div class="bg-white rounded-lg shadow-md">
                ...
                <div class="hidden print:block p-8 text-center border-b border-gray-300">
                    <h1 class="text-2xl font-bold text-gray-800 mb-2">LAPORAN BARANG MASUK</h1>
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 border">Jumlah Masuk</th>
